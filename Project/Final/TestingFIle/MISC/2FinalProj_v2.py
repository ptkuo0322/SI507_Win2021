...
read_clients = pd.read_csv(f'/Users/pkuo/Desktop/SI507_finalProject/{filenameC}')
if len(query_name) == 0:
...
print(youtube_response['pageInfo'])
alist = []
alist.append(name_list[int(choose_restaurant)-1])
alist.append(youtube_response['pageInfo']["totalResults"])
alist.append(youtube_response['regionCode'])
