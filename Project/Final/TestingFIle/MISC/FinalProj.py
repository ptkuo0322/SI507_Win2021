...
headers = ['RestaurantName', 'PhoneNumber', 'ReviewCount', 'Rating','Address', 'Longitude', 'Latitude', 'UrlLink']
...
# create csv file for SQL database and furture use [need to add with cache]
headers = ['RestaurantName', 'TotalResultOnYT', 'GroupId']

with open('Youtube1.csv', 'w') as outfile:
    csvwriter = csv.writer(outfile)
    csvwriter.writerow(headers)
    csvwriter.writerows(outer_list)
